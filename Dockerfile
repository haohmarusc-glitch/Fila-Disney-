...
COPY monitor.py notifier.py localizacao.py personagens.py analyze.py healthcheck.py healthcheck_api.py coords.py duracoes.py api_server.py watchlist.json ./
